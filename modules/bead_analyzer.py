...
class Ui_BeadAnalyzer(QtWidgets.QMainWindow):
    def setupUi(self, BeadAnalyzer, app, fiducials, particles):
        ...
        self.selectAll.setGeometry(QtCore.QRect(10, 480, 96, 32))
        self.selectAll.setObjectName("selectAll")
        self.selectAll.clicked.connect(self.select_all)
        self.on = True

        self.smoothingFactorLabel = QtWidgets.QLabel(self.centralwidget)
        self.smoothingFactorLabel.setGeometry(QtCore.QRect(120, 450, 120, 30))
        self.smoothingFactorLabel.setObjectName("smoothingFactorLabel")

        self.smoothingFactor = QtWidgets.QTextEdit(self.centralwidget)
        self.smoothingFactor.setGeometry(QtCore.QRect(120, 480, 96, 32))
    ...
    def retranslateUi(self, BeadAnalyzer):
        ...
        self.smoothingFactor.setHtml(_translate("BeadAnalyzer", "101"))
        self.smoothingFactorLabel.setText(_translate("BeadAnalyzer", "Smoothing factor:"))
    ...
    def dr_corr_2(self, mother_app, fiducials, particles, fiducial_ids):
        ...
        self.smoothingFactorValue = float(self.smoothingFactor.toPlainText())
        drift = Drift(fiducials, self.smoothingFactorValue)
